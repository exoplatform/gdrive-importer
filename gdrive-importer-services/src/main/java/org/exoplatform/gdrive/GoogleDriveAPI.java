 ...
 */
public class GoogleDriveAPI implements DataStoreFactory {
   ...
   */
  public class ChildIterator extends ChunkIterator<ChildReference> {
   ...
   */
  public About about() throws GoogleDriveException, CloudDriveAccessException {
    try {
   ...
   * @throws GoogleDriveException the google drive exception
   */
  public ChildIterator children(String fileId) throws GoogleDriveException {
